...
From:    BANCO COMERCIAL PORTUGUÊS S\.A\., MACAU BRANCH \(the Increase Lender\)
Date:     19 DEC 2023
...
4\.The proposed date on which the increase in relation to the Increase Lender and the Relevant Commitment is to take effect \(the Increase Date\) is 19 DEC 2023\.
...
| /s/ Vong Sau Mui | /s/ Constantino Mousinho |
| ------------------------ | -------------------------- |
| Vong Sau Mui | Constantino Mousinho |
| Deputy General Manager | General Manager |


*This Confirmation is accepted as an Increase Confirmation for the purposes of the Agreement by the Facility Agent and the Increase Date is confirmed as 19 DEC 2023\.*
