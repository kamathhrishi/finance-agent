...
|                                                        | A                | B               | C                     |
|--------------------------------------------------------|------------------|-----------------|-----------------------|
|                                                        | Numberof         | Weighted-       | Numberofsecurities    |
|                                                        | securitiestobe   | averageexercise | remainingavailablefor |
|                                                        | issuedupon       | priceof         | futureissuanceunder   |
|                                                        | exerciseof       | outstanding     | equitycompensation    |
|                                                        | outstanding      | options,        | plans(excluding       |
|                                                        | options,warrants | warrantsand     | securitiesreflectedin |
| PlanCategory                                           | andrights        | rights          | column(A))            |
